...
fn test_binning_sentinel_phi() {
    ...
    assert_eq!(lib.backbone_bin("TST", 9999.0, -120.0).unwrap(), 4);
}

#[test]
fn test_binning_sentinel_psi() {
    let (_t, lib) = make_3x3_lib();
    assert_eq!(lib.backbone_bin("TST", -120.0, 9999.0).unwrap(), 4);
}

#[test]
fn test_binning_sentinel_both() {
    let (_t, lib) = make_3x3_lib();
    assert_eq!(lib.backbone_bin("TST", 9999.0, 9999.0).unwrap(), 4);
}
...
fn test_binning_exact_center() {
    ...
    assert_eq!(lib.backbone_bin("TST", 0.0, 0.0).unwrap(), 4);
}
...
fn test_binning_known_corner() {
    ...
    assert_eq!(lib.backbone_bin("TST", -120.0, -120.0).unwrap(), 0);
}
...
fn test_binning_known_edge() {
    ...
    assert_eq!(lib.backbone_bin("TST", 120.0, 0.0).unwrap(), 7);
}
...
fn test_binning_near_center_offset() {
    ...
    assert_eq!(lib.backbone_bin("TST", 40.0, -40.0).unwrap(), 4);
}
...
fn test_binning_wrap_around_pos() {
    ...
    assert_eq!(lib.backbone_bin("TST", 179.9, 0.0).unwrap(), 7);
}
...
fn test_binning_wrap_around_neg() {
    ...
    assert_eq!(lib.backbone_bin("TST", -180.0, 0.0).unwrap(), 1);
}
...
fn test_binning_tie_lower_bin_wins() {
    ...
    assert_eq!(lib.backbone_bin("TST", 60.0, 0.0).unwrap(), 4);
}
