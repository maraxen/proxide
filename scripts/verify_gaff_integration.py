...
from priox_rs import CoordFormat, OutputSpec, parse_structure
...
def test_gaff_integration():
    ...
    if not os.path.exists(pdb_path):
        raise FileNotFoundError(f"File {pdb_path} not found. Please run scripts/generate_trajectory_test_data.py first.")
