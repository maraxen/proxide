...
from priox.io.parsing.rust_wrapper import OutputSpec, parse_structure
...
def verify_structural_data():
    ...
    if protein.proper_dihedrals is not None:
        ...
        print("WARNING: proper_dihedrals is None (might be expected for simple inference if no ForceField XML providing params, but GAFF typing implies inference?)")
