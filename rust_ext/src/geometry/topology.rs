...
use crate::geometry::neighbors::find_neighbors_within_cutoff;
...
pub fn infer_bonds(
    ...
    let neighbors = find_neighbors_within_cutoff(coords, max_cutoff);
...
mod tests {
    ...
    fn test_infer_bonds_methane() {
        ...
        // Check connectivity
        for bond in bonds {
            assert!(bond[0] == 0 || bond[1] == 0, "All bonds must connect to C (index 0)");
        }
    }
