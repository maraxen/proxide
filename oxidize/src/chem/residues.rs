...
fn get_residue_atoms() -> HashMap<&'static str, Vec<&'static str>> {
    ...
    map.insert("ARG", vec!["C", "CA", "CB", "CG", "CD", "CZ", "N", "NE", "O", "NH1", "NH2"]);
    map.insert("ASP", vec!["C", "CA", "CB", "CG", "N", "O", "OD1", "OD2"]);
    map.insert("ASN", vec!["C", "CA", "CB", "CG", "N", "ND2", "O", "OD1"]);
    map.insert("CYS", vec!["C", "CA", "CB", "N", "O", "SG"]);
    map.insert("GLU", vec!["C", "CA", "CB", "CG", "CD", "N", "O", "OE1", "OE2"]);
    map.insert("GLN", vec!["C", "CA", "CB", "CG", "CD", "N", "NE2", "O", "OE1"]);
    map.insert("GLY", vec!["C", "CA", "N", "O"]);
    map.insert("HIS", vec!["C", "CA", "CB", "CG", "CD2", "CE1", "N", "ND1", "NE2", "O"]);
    map.insert("ILE", vec!["C", "CA", "CB", "CG1", "CG2", "CD1", "N", "O"]);
    map.insert("LEU", vec!["C", "CA", "CB", "CG", "CD1", "CD2", "N", "O"]);
    map.insert("LYS", vec!["C", "CA", "CB", "CG", "CD", "CE", "N", "NZ", "O"]);
    map.insert("MET", vec!["C", "CA", "CB", "CG", "CE", "N", "O", "SD"]);
    map.insert("PHE", vec!["C", "CA", "CB", "CG", "CD1", "CD2", "CE1", "CE2", "CZ", "N", "O"]);
    map.insert("PRO", vec!["C", "CA", "CB", "CG", "CD", "N", "O"]);
    map.insert("SER", vec!["C", "CA", "CB", "N", "O", "OG"]);
    map.insert("THR", vec!["C", "CA", "CB", "CG2", "N", "O", "OG1"]);
    map.insert("TRP", vec!["C", "CA", "CB", "CG", "CD1", "CD2", "CE2", "CE3", "CZ2", "CZ3", "CH2", "N", "NE1", "O"]);
    map.insert("TYR", vec!["C", "CA", "CB", "CG", "CD1", "CD2", "CE1", "CE2", "CZ", "N", "O", "OH"]);
...
pub fn build_restype_atom14_names() -> HashMap<&'static str, Vec<&'static str>> {
    ...
    map.insert("ALA", vec!["N", "CA", "C", "O", "CB", "", "", "", "", "", "", "", "", ""]);
    map.insert("ARG", vec!["N", "CA", "C", "O", "CB", "CG", "CD", "NE", "CZ", "NH1", "NH2", "", "", ""]);
    map.insert("ASN", vec!["N", "CA", "C", "O", "CB", "CG", "OD1", "ND2", "", "", "", "", "", ""]);
    map.insert("ASP", vec!["N", "CA", "C", "O", "CB", "CG", "OD1", "OD2", "", "", "", "", "", ""]);
    map.insert("CYS", vec!["N", "CA", "C", "O", "CB", "SG", "", "", "", "", "", "", "", ""]);
    map.insert("GLN", vec!["N", "CA", "C", "O", "CB", "CG", "CD", "OE1", "NE2", "", "", "", "", ""]);
    map.insert("GLU", vec!["N", "CA", "C", "O", "CB", "CG", "CD", "OE1", "OE2", "", "", "", "", ""]);
    map.insert("GLY", vec!["N", "CA", "C", "O", "", "", "", "", "", "", "", "", "", ""]);
    map.insert("HIS", vec!["N", "CA", "C", "O", "CB", "CG", "ND1", "CD2", "CE1", "NE2", "", "", "", ""]);
    map.insert("ILE", vec!["N", "CA", "C", "O", "CB", "CG1", "CG2", "CD1", "", "", "", "", "", ""]);
    map.insert("LEU", vec!["N", "CA", "C", "O", "CB", "CG", "CD1", "CD2", "", "", "", "", "", ""]);
    map.insert("LYS", vec!["N", "CA", "C", "O", "CB", "CG", "CD", "CE", "NZ", "", "", "", "", ""]);
    map.insert("MET", vec!["N", "CA", "C", "O", "CB", "CG", "SD", "CE", "", "", "", "", "", ""]);
    map.insert("PHE", vec!["N", "CA", "C", "O", "CB", "CG", "CD1", "CD2", "CE1", "CE2", "CZ", "", "", ""]);
    map.insert("PRO", vec!["N", "CA", "C", "O", "CB", "CG", "CD", "", "", "", "", "", "", ""]);
    map.insert("SER", vec!["N", "CA", "C", "O", "CB", "OG", "", "", "", "", "", "", "", ""]);
    map.insert("THR", vec!["N", "CA", "C", "O", "CB", "OG1", "CG2", "", "", "", "", "", "", ""]);
    map.insert("TRP", vec!["N", "CA", "C", "O", "CB", "CG", "CD1", "CD2", "NE1", "CE2", "CE3", "CZ2", "CZ3", "CH2"]);
    map.insert("TYR", vec!["N", "CA", "C", "O", "CB", "CG", "CD1", "CD2", "CE1", "CE2", "CZ", "OH", "", ""]);
    map.insert("VAL", vec!["N", "CA", "C", "O", "CB", "CG1", "CG2", "", "", "", "", "", "", ""]);
    map.insert("UNK", vec!["", "", "", "", "", "", "", "", "", "", "", "", "", ""]);
